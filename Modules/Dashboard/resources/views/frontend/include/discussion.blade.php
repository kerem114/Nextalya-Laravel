<div class="product-post-card">
    ...
    <div class="product-post-footer">
        <div class="product-post-left-icons">
            ...
            <a href="{{ route('discussion.show',$take->slug) }}" class="product-post-icon">
        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-body text-center">
                <div class="d-flex justify-content-center gap-3 mb-3">
                    <a href="mailto:?body={{ urlencode(route('discussion.show',$take->slug)) }}" class="btn btn-outline-secondary"><i class="bi bi-envelope"></i></a>
                    <a href="https://wa.me/?text={{ urlencode(route('discussion.show',$take->slug)) }}" target="_blank" class="btn btn-outline-success"><i class="bi bi-whatsapp"></i></a>
                    <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('discussion.show',$take->slug)) }}" target="_blank" class="btn btn-outline-primary"><i class="bi bi-linkedin"></i></a>
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('discussion.show',$take->slug)) }}" target="_blank" class="btn btn-outline-dark"><i class="bi bi-twitter-x"></i></a>
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('discussion.show',$take->slug)) }}" target="_blank" class="btn btn-outline-primary"><i class="bi bi-facebook"></i></a>
                </div>
                <div class="input-group">
                    <input type="text" id="shareLink{{ $take->id }}" class="form-control" value="{{ route('discussion.show',$take->slug) }}" readonly>
